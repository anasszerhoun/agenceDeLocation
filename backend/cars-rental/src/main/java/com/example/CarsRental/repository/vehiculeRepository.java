...
public interface vehiculeRepository extends JpaRepository<Vehicule,Long> {
    ...
    @Query("SELECT new com.example.CarsRental.dto.vehiculeStatDTO(r.immatriculation) FROM Vehicule r WHERE r.status = :status")
    List<vehiculeStatDTO> findByStatus(@Param("status") String status);
